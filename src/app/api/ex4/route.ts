...
const TEMPLATE = `You are an AI assistant bot for HeadCommerce! Be friendly, and polite. Keep your answers short. Answer the user's questions based on the following context.:
==============================
Context: {context}
==============================
